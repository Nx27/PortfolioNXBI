  ...
  public record ProjectDetails
  {
    ...
    public static Task<List<ProjectDetails>> GetAllProjects()
    {
      if (AllProjects.Count == 0)
      {
        ...
        new ProjectDetails("Chunk System", "My biggest refactor ever", "Projects/ChunkSytemRefactor", "", "2 months", "", new Dictionary<FilterOptions, string[]>() { { FilterOptions.Languages, ["C#"] }, { FilterOptions.Frameworks, ["UnityEngine"] }, { FilterOptions.Software, ["ClickUp"] } });
