namespace Portfolio.Logic.CS
{
  ...
  public record ProjectDetails
  {
    ...
    public static Task<List<ProjectDetails>> GetAllProjects()
    {
      if (AllProjects.Count == 0)
      {
        ...
        new ProjectDetails("Siepie and Takkie", "Swedish-Dutch joint project", "Projects/SiepieAndTakkieOriginal", "images/projects/siepietakkieoriginal/SiepieTakkiePoster.png", "3 Weeks", "https://github.com/Nx27-ma/siepie", new Dictionary<FilterOptions, string[]>() { { FilterOptions.Languages, ["C#"] }, { FilterOptions.Frameworks, ["UnityEngine"] } });
        ...
        new ProjectDetails("Chunk System", "My biggest refactor ever", "Projects/ChunkSytemRefactor", "images/projects/refactorchunksystem/ChunkRefactorPicture.png", "2 months", "", new Dictionary<FilterOptions, string[]>() { { FilterOptions.Languages, ["C#"] }, { FilterOptions.Frameworks, ["UnityEngine"] }, { FilterOptions.Software, ["ClickUp"] } });
        new ProjectDetails("Loading Screen", "A loading screen for IBX", "Projects/LoadingScreen", "images/projects/loadingscreen/LoadingScreen.gif", "2 Days", "", new Dictionary<FilterOptions, string[]>() { { FilterOptions.Languages, ["C#"] }, { FilterOptions.Frameworks, ["UnityEngine"] }, { FilterOptions.Software, ["ClickUp"] } });
      }
      return Task.FromResult(AllProjects); ;
    }
