  ...
  public record ProjectDetails
  {
    ...
    public static List<ProjectDetails> GetAllProjects()
    {
      if (AllProjects.Count == 0)
      {
        ...
        new ProjectDetails("Loading Screen", "A simple loading screen implementation", "Projects/LoadingScreen", "images/projects/loadingscreen/LoadingScreen.gif", "2 Days", "", new Dictionary<FilterOptions, string[]>() { { FilterOptions.Languages, ["C#"] }, { FilterOptions.Frameworks, ["UnityEngine"] }, { FilterOptions.Software, ["ClickUp"] } });
      }
      return AllProjects;
    }
